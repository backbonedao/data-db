...
const YoloIndex = exports.YoloIndex = {
  buffer: true,
  encodingLength: null,
  encode: null,
  decode: null
...
const Extension = exports.Extension = {
  buffer: true,
  encodingLength: null,
  encode: null,
  decode: null
  ...
  function encodingLength (obj) {
    ...
    if (defined(obj.levels)) {
      for (let i = 0; i < obj.levels.length; i++) {
        ...
        const len = Level.encodingLength(obj.levels[i])
...
function defineExtension () {
  ...
  const Iterator = Extension.Iterator = {
    buffer: true,
    encodingLength: null,
    encode: null,
    decode: null
  ...
  function defineIterator () {
    ...
    function encodingLength (obj) {
      ...
      if (defined(obj.checkpoint)) {
        let packedLen = 0
        for (let i = 0; i < obj.checkpoint.length; i++) {
